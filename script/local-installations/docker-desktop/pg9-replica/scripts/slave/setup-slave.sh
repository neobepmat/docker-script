...
if [[ ! -a ${SLAVE_PGDATA}/.do-not-repeat-init ]] ; then
    ...
    chmod 700 ${SLAVE_PGDATA}/recovery.conf
...
echo Creating file to avoid multiple execution of this script
touch ${SLAVE_PGDATA}/.do-not-repeat-init
