...
pg_basebackup -h $MASTER_HOSTNAME -p $MASTER_PORT -U $MASTER_USER_REPLICATOR -D $SLAVE_PGDATA --checkpoint=fast -R --slot=$MASTER_SLOT_REPLICATOR --tablespace-mapping=/usr/pg/usr_tblspcs/BOD_TACO_TBS.NDF=/usr/pg/usr_tblspcs/BOD_TACO_TBS.NDF --tablespace-mapping=/usr/pg/usr_tblspcs/TACO_M00A.DBF=/usr/pg/usr_tblspcs/TACO_M00A.DBF --tablespace-mapping=/usr/pg/usr_tblspcs/TACO_M01A.DBF=/usr/pg/usr_tblspcs/TACO_M01A.DBF --tablespace-mapping=/usr/pg/usr_tblspcs/TACO_M01B.DBF=/usr/pg/usr_tblspcs/TACO_M01B.DBF --tablespace-mapping=/usr/pg/usr_tblspcs/TACO_M04A.DBF=/usr/pg/usr_tblspcs/TACO_M04A.DBF --tablespace-mapping=/usr/pg/usr_tblspcs/TACO_M04B.DBF=/usr/pg/usr_tblspcs/TACO_M04B.DBF --tablespace-mapping=/usr/pg/usr_tblspcs/TACO_U.DBF=/usr/pg/usr_tblspcs/TACO_U.DBF;


echo "Writing settings for postgresql.conf file";
cat > /etc/postgresql/postgresql.conf <<EOS
hot_standby = on
wal_level = replica
